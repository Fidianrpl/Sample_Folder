let testText = "Quiero ser un programador chirrete este 2026 :V";
let startTime, endTime;

function startTest() {
    //Recuperar el texto de prueba
...
function endTest() {
    ...
    var totalTypes = userTypedText.length;
